...
if(isset($_POST['patsub1']))
{
  ...
  $select = mysqli_query($con, "SELECT * FROM patreg WHERE email = '".$_POST['email']."'");
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Brooklyn Hospital</a>
